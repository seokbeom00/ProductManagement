	...
	public ProductSystemUI() {
		...
		table.addMouseListener(new MouseListener() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				//TODO : 테이블 한 로우 선택 시 하단 패널의 텍스트 박스를 선택한 로우의 내용으로 채우는 코드를 작성하시오 (O)
				txt1.setText(id);
				txt2.setText(name);
				txt3.setText(status);
...
//					// TODO : 로그인 버튼 클릭 시 화면전환을 구현하시오 (O)
...
//					// TODO : 수정 버튼 클릭 시 하단 패널의 텍스트 박스 비우기를 구현하시오 (O)
//					v.txt1.setText(null);
//					v.txt2.setText(null);
//					v.txt3.setText(null);
//					v.txt4.setText(null);
//				} else if (obj == v.deleteButton) {
//					// TODO : 삭제 버튼 클릭 시 하단 패널의 텍스트 박스 비우기를 구현하시오 (O)
//					v.txt1.setText(null);
//					v.txt2.setText(null);
//					v.txt3.setText(null);
//					v.txt4.setText(null);
